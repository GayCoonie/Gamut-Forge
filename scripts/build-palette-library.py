...
scripts=['palettes.js','retro-source-union-4096.js','retro-source-union-1024.js','critter-palettes.js','hsv-three-tier-64.js','hsv-three-tier-10.js','hsv-three-tier-sketch.js','random-strata.js','random-strata-v2-trials.js','okhsv-sketch.js','oklab-rings.js','okhwb-triangle.js','okhwb-staggered.js','okhwb-walks.js','martian-expansion.js']
...
rows=[
('martianExpansion1024','martian-expansion-1024','Artist-derived wheels','An independent expansion of Warren Mars’s final Martian wheel. All 120 published RGB anchors remain intact; HSLuv interpolation expands 24 source families to 48. Version 2 relocates an outer tint into the inner shades and uses perceptual lightness throughout. Thirteen shade/tint samples and eight equal-luminance muted companions per family, plus 16 grays, yield 1,024 colors. The added rules are Gamut Forge’s, with full source attribution.','martian-expansion.html'),
('okhwbWalks1024','okhwb-walks-1024','OKHWB experiments','Version 3 assigns one continuous 21-step hue walk to each regular W/B triangle. The three sketch traversals and their W/B mirrors cycle every six source hues. Only the 48 vivid tips keep their source hue; 960 other samples advance toward the next hue, and the original 16 grays remain. Includes numbered paths and a v1/v2/v3 comparison.','okhwb-walks.html'),
('okhwbStaggered1024','okhwb-staggered-1024','OKHWB experiments','Version 2 keeps the regular 21-cell W/B triangle, 48 vivid anchors and 16 grays. Dot-count hue offsets interleave 576 hue angles across the 1,008 colored samples. The unchanged-hue cells follow the user’s curved path; the other cells advance within each 7.5° source sector. No perceptual pruning or fillers.','okhwb-staggered.html'),
('okhwbTriangle1024','okhwb-triangle-1024','OKHWB experiments','48 hue slices at 7.5° intervals, with 21 regularly spaced white/black pairs per hue and 16 shared grays. All 1,024 colors are distinct after ordinary sRGB rounding. The triangular lattice is preserved exactly, with no perceptual pruning or fillers. Includes a vector triangle atlas.','okhwb-triangle.html'),
('oklabRings1024','oklab-rings-1024','Oklab experiments','Seven Oklab lightness slices, 24 hue angles and eight chroma rings produce 1,133 unique clipped sRGB colors. A hard CIEDE2000 separation filter retains 837; 187 unchanged colors from OKHSV Sketch, including black, complete the palette. All 1,024 colors are mutually at least 2 ΔE00 apart. Requested Oklab coordinates change where RGB channels are clipped.','oklab-rings.html'),
